...
# Finally, the lanalytics package can be installed from Github:
install.packages("devtools")
install_github(repo = "savrgg/lanalytics")

```

## Getting started with the package

First of all, the tidyverse, shiny and lanalytics should be loaded:
...
For each file, the lanalytics package creates a __quiz object__ with several properties and a special format:

```{r}
# modify modify
```

Also, different quiz objects can be joined together to create a __course object__:
