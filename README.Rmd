...
For each file, the lanalytics package creates a __quiz object__ with several properties and a special format (not yet):

```{r}
# modify modify
```

Also, different quiz objects can be joined together to create a __course object__ (not yet):
